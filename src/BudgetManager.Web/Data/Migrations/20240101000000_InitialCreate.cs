    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LockedMonths", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LockedMonths_AspNetUsers_LockedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContainsText = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LockedMonths_LockedByUserId",
                table: "LockedMonths",
                column: "LockedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LockedMonths_Year_Month",
                table: "LockedMonths",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_Date_Amount_AccountId",
                table: "Transactions",
                columns: new[] { "Date", "Amount", "AccountId" });
